...
namespace Pong {
    class Pong1Player {
        static public void Run() {
            ...
            Ball ball = new Ball(120, 30);

            Paddle player1 = new Paddle(3, 3);      
            //starts the ball moving toward the player
            ...
            void ballCollision() {
                ...
                for (int i = 0; i < paddleSize + 1; i++) {
                    ...
                    //BrainPad.WriteToComputer("Test No: " +test);
                    if (ball.getY() == test)
                        if (ball.getX() < 8) {
        ...
        class Ball {
            ...
            // STOP = 0, LEFT = 1, UPLEFT = 2, DOWNLEFT = 3, RIGHT = 4, UPRIGHT = 5, DOWNRIGHT = 6 
            //insures no straight shots from player 1
            ...
            //insures no straight shots player 2
