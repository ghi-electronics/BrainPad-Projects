        ...
        static public void Run() {
            ...
            while (true) {
                ...
                if (key == -1) {
                    ...
                    BrainPad.Buzzer.StartBuzzing(155.56);//D#          
                }
                else if (key == 6) {
                    drawNotes(key);

                    BrainPad.Buzzer.StartBuzzing(185);//F#
                }
                else if (key == 5) {
                    drawNotes(key);

                    BrainPad.Buzzer.StartBuzzing(207.65);//G#
                }
                else if (key == 3) {
                    drawNotes(key);

                    BrainPad.Buzzer.StartBuzzing(220);//A
                }
                else if (key == 2) {
                    drawNotes(key);

                    BrainPad.Buzzer.StartBuzzing(233.08);//A#
                }
                else if (key == 1) {
                    drawNotes(key);

                    BrainPad.Buzzer.StartBuzzing(277.18);//Key of C#
                }
                else if (key == 0) {
                    drawNotes(key);

                    BrainPad.Buzzer.StartBuzzing(311.13);//Key of D#
                }
            ...
            void drawNotes(int key)
            {
                ...
                switch (key) {
                    case 7:
                        BrainPad.Display.DrawSmallText(11, 44, "D");

                        BrainPad.Display.DrawSmallText(20, 44, "#");
                    ...
                    case 6:
                        ...
                        break;
                    case 5:
                        BrainPad.Display.DrawSmallText(38, 44, "G");

                        BrainPad.Display.DrawSmallText(47, 44, "#");

                        break;
                    case 3:
                        BrainPad.Display.DrawSmallText(47, 55, "A");

                        break;
                    case 2:
                        BrainPad.Display.DrawSmallText(47, 44, "A");

                        BrainPad.Display.DrawSmallText(56, 44, "#");

                        break;
                    case 1:
                        BrainPad.Display.DrawSmallText(65, 44, "C");

                        BrainPad.Display.DrawSmallText(74, 44, "#");

                        break;
                    case 0:
                        BrainPad.Display.DrawSmallText(75, 44, "D");

                        BrainPad.Display.DrawSmallText(84, 44, "#");

                        break;

                    default:
                        //Clears the display when the notes aren't playing
                        BrainPad.Display.ClearPartOfScreen(11, 44, 5, 8);

                        BrainPad.Display.ClearPartOfScreen(20, 44, 5, 8);

                        BrainPad.Display.ClearPartOfScreen(30, 44, 5, 8);

                        BrainPad.Display.ClearPartOfScreen(39, 44, 5, 8);
                        ...
                        BrainPad.Display.ClearPartOfScreen(65, 44, 5, 8);

                        BrainPad.Display.ClearPartOfScreen(74, 44, 5, 8);
            ...
            void drawKeyBoard()
            {
                ...
                //Adds Banner
                BrainPad.Display.DrawText(0, 0, "Key of D#m  ");
