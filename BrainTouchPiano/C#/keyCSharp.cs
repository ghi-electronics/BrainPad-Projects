        ...
        static public void Run() {
            ...
            while (true) {
                ...
                if (key == -1) {
                    ...
                    BrainPad.Buzzer.StartBuzzing(138.59);//C#          
                }
                else if (key == 6) {
                    drawNotes(key);

                    BrainPad.Buzzer.StartBuzzing(164.81);//E
                }
                else if (key == 5) {
                    drawNotes(key);
                    ...
                    BrainPad.Buzzer.StartBuzzing(207.65);//Key of G#
                }
                else if (key == 1) {
                    drawNotes(key);

                    BrainPad.Buzzer.StartBuzzing(246.94);//Key of B
                }
                else if (key == 0) {
                    drawNotes(key);
            ...
            void drawNotes(int key) {
                ...
                switch (key) {
                    case 7:
                        BrainPad.Display.DrawSmallText(3, 44, "C");

                        BrainPad.Display.DrawSmallText(11, 44, "#");

                        break;
                    case 6:
                        BrainPad.Display.DrawSmallText(20, 55, "E");
                    ...
                    case 2:
                        ...
                        break;
                    case 1:
                        BrainPad.Display.DrawSmallText(47, 55, "B");
            ...
            void drawKeyBoard() {
                ...
                //Adds Banner
                BrainPad.Display.DrawText(0, 0, " Key of C#  ");
