        ...
        static public void Run() {
            ...
            while (true) {
                ...
                if (key == -1) {
                    ...
                    BrainPad.Buzzer.StartBuzzing(311.13);//D#
                }
                else if (key == 2) {
                    drawNotes(key);
                    ...
                    BrainPad.Buzzer.StartBuzzing(440);//A
                }
            }
            ...
            void drawNotes(int key)
            {
                switch (key) {
                    ...
                    case 2:
                        ...
                        break;
                    case 1:
                        BrainPad.Display.DrawSmallText(101, 55, "G");

                        break;
                    case 0:
                        BrainPad.Display.DrawSmallText(110, 55, "A");
                    ...
                    default:
                        ...
                        BrainPad.Display.ClearPartOfScreen(101, 55, 5, 8);
            ...
            void drawKeyBoard()
            {
                ...
                //Adds Banner
                BrainPad.Display.DrawText(0, 0, " Key of Am  ");
