        ...
        static public void Run() {
            ...
            while (true) {
                ...
                if (key == -1) {
                    ...
                    BrainPad.Buzzer.StartBuzzing(207.65);//Ab
                }
                else if (key == 5) {
                    drawNotes(key);
                    ...
                    BrainPad.Buzzer.StartBuzzing(311.13);//Eb
                }
                else if (key == 0) {
                    drawNotes(key);
            ...
            void drawNotes(int key) {
                ...
                switch (key) {
                    case 7:
                        ...
                        break;
                    case 6:
                        BrainPad.Display.DrawSmallText(38, 44, "A");
                    ...
                    case 2:
                        ...
                        break;
                    case 1:
                        BrainPad.Display.DrawSmallText(75, 44, "E");

                        BrainPad.Display.DrawSmallText(84, 44, "b");
                        break;
                    case 0:
