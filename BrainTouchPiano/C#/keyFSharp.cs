        ...
        static public void Run() {
            ...
            while (true) {
                ...
                if (key == -1) {
                    ...
                    BrainPad.Buzzer.StartBuzzing(246.94);//B
                }
                else if (key == 3) {
                    drawNotes(key);
                    ...
                    BrainPad.Buzzer.StartBuzzing(369.99);//F#
                }
                //Press LEFT button to Exit
                if (BrainPad.Buttons.IsLeftPressed())
                    return;
            ...
            void drawNotes(int key) {
                ...
                switch (key) {
                    case 7:
                        BrainPad.Display.DrawSmallText(29, 44, "F");

                        BrainPad.Display.DrawSmallText(38, 44, "#");
                        break;
                    case 6:
                        BrainPad.Display.DrawSmallText(47, 55, "A");
                        break;
                    case 5:
                        BrainPad.Display.DrawSmallText(56, 55, "B");
                    ...
                    case 2:
                        ...
                        break;
                    case 1:
                        BrainPad.Display.DrawSmallText(83, 55, "E");
                        break;
                    case 0:
                        BrainPad.Display.DrawSmallText(92, 44, "F");

                        BrainPad.Display.DrawSmallText(101, 44, "#");
                        break;

                    default:
                        //Clears the display when the notes aren't playing
                        BrainPad.Display.ClearPartOfScreen(29, 44, 5, 8);
            ...
            void drawKeyBoard() {
                ...
                //Adds Banner
                BrainPad.Display.DrawText(0, 0, "Key of F#m  ");
