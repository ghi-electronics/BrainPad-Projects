        ...
        static public void Run() {
            ...
            while (true) {
                ...
                if (key == -1) {
                    ...
                    BrainPad.Buzzer.StartBuzzing(146.83);//D         
                }
                else if (key == 6) {
                    drawNotes(key);

                    BrainPad.Buzzer.StartBuzzing(174.61);//F;
                }
                else if (key == 5) {
                    drawNotes(key);
            ...
            void drawNotes(int key) {  
                ...
                switch (key) {
                    case 7:
                        BrainPad.Display.DrawSmallText(12, 55, "D");
                        
                        break;
                    case 6:
                        BrainPad.Display.DrawSmallText(29, 55, "F");
                    ...
                    default:
                        ...
                        BrainPad.Display.ClearPartOfScreen(12, 55, 5, 8);
            ...
            void drawKeyBoard() {
                ...
                BrainPad.Display.DrawText(0, 0, " Key of Dm  ");
