...
namespace Click.Radio {
    ...
    public class RadioFM1 {
        ...
        public RadioFM1() {
            ...
            this.resetPin = GpioController.GetDefault().OpenPin(BrainPad.Expansion.GpioPin.Rst);// brainew OutputPort(BrainPadExpansion.Gpio.E2, false);
            this.resetPin.SetDriveMode(GpioPinDriveMode.Output);
            this.selPin = GpioController.GetDefault().OpenPin(BrainPad.Expansion.GpioPin.Cs);// brainew OutputPort(BrainPadExpansion.Gpio.E2, false);
            ...
            //this.i2c = new I2CDevice(new I2CDevice.Configuration(RadioFM1.I2C_ADDRESS, 400));
